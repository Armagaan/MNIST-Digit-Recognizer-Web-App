...
st.header("Digit Recognition using ANN")
st.write("The ANN was trained on the [MNIST dataset](http://yann.lecun.com/exdb/mnist/).")
st.write('''
    Draw any digit from 0-9 in the **Canvas** box to see the rescaled version of it in the **Model Input** box.
    Hit the **Predict** button to see the predictions. You can vary the brush side in the sidebar.
''')
st.write('''_(It may show absurd results sometimes.)_''')
